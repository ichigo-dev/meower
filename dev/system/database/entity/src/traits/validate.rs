...
//! # Provided methods
//!
//! - `validate_and_save`: Validates and saves the active model.
//! - `validate_and_insert`: Validates and inserts the active model.
//! - `validate_and_update`: Validates and updates the active model.
//------------------------------------------------------------------------------
